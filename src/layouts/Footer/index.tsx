            ...
            <div className='footer-container'>
                <div className='footer-top'>
                    <div className='footer-logo-box'>
                        ...
                        <div className='footer-logo-text'>Hongkyu's Board</div>
                    </div>
                    <div className='footer-link-box'>
                        <div className='footer-email-link'>{'hongkyu08@gmail.com'}</div>
                ...
                <div className='footer-bottom'>
                    <div className='footer-copyright'>{'Copyright © 2024 Hongkyu All rights reserved'}</div>
                </div>
            </div>
        </div>
    )
